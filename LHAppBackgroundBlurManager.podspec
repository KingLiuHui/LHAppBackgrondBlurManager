#
#  Be sure to run `pod spec lint LHAppBackgroundBlurManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "LHAppBackgroundBlurManager"
  s.version      = "0.0.1"
  s.summary      = "一行代码搞定后台模糊功能，保护APP的隐私."
  ...
  s.author             = { "刘辉" => "1054539558@qq.com" }
  # Or just: s.author    = ""
  # s.authors            = { "" => "" }
    s.social_media_url   = "https://my.oschina.net/iOSliuhui"
